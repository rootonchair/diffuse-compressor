...
def run_model_cli() -> None:
    ...
    output = "outputs/checkpoints/svdq-int4_r32-flux.1-schnell.safetensors"
    ...
    if args.output == output:
        args.output = f"outputs/checkpoints/svdq-{args.precision}_r32-flux.1-schnell.safetensors"
    cache_dir = args.cache_dir or "outputs/calibration/flux.1-schnell"
    pipe = load_pipeline(
        "FluxPipeline",
        args.model_id,
        device=args.device,
