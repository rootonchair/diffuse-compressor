...
def run_model_cli() -> None:
    ...
    if args.output == output:
        args.output = f"outputs/checkpoints/svdq-{args.precision}_r32-flux2-klein-9b.safetensors"
...
def flux2_klein_target_config(
    ...
    *,
    ...
    return TargetConfig(
        ...
        targets=[
            TargetRule(parent_module_classes=Flux2Attention, member_selector=qkv_members, export_name="{parent_path}.to_qkv"),
            TargetRule(
